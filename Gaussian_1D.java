...
public class Gaussian_1D implements PlugInFilter {
       ...
       for(int i= 0; i< H.length;i++)
       {
        ...
        //along x- direction
        	for (int v = 0; v <= N - 1; v++) {
                ...
                //dividing by sumKernel to avoid picture getting brighter
                int q = (int) (sum/sumKernel);
                // clamp result:
                if (q < 0)   q = 0;
                if (q > 255) q = 255;
                tmp.putPixel(u, v, q);
